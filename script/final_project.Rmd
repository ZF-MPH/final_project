...
longer_teen_bmi_1 <- teen_w_bmi_1 %>% 
  pivot_longer(
    ...
    values_to = "minutes", 
    values_drop_na = TRUE) %>%
  select(PID, TSEX, TGRADE, bmi, MVPA_when, minutes) 
...
teen_w_bmi_1 %>% 
  ggboxplot(x = "TSCHLTYPE", y = "total_pa_wk_min",
            add = c("mean_se"),
            color = "TSCHLTYPE", palette = c("yellow", "blue", 
                                             "red", "black"),
            order = c("Another kind of school", "Home-schooled",
                      "Public school", "Private school"),
            ylab = "Minutes/Wk of PA",
            xlab = "School Type")

teen_w_bmi_1 %>% 
  ggline(x = "TSCHLTYPE", y = "total_pa_wk_min", 
       add = c("mean_se"), 
       order = c("Another kind of school", "Home-schooled",
                      "Public school", "Private school"),
       ylab = "Minutes/Wk of PA",
...
teen_w_bmi_1 %>% 
  ggboxplot(x = "TAGE.y", y = "total_pa_wk_min",
            add = c("mean_se"),
            color = "TAGE.y", palette = c("yellow", "blue", 
                                          "red", "black",
                                          "grey"),
